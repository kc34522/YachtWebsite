<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="TayanaYacht.WebForm1" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <link href="<%= ResolveUrl("~/Assets/css/homestyle.css") %>" rel="stylesheet" type="text/css" />
    <link href="<%= ResolveUrl("~/Assets/css/reset.css") %>" rel="stylesheet" type="text/css" />
</head>
<body>
...
<!--遮罩-->
<div class="bannermasks"><img src="<%= ResolveUrl("~/Assets/images/contact.jpg") %>" alt="&quot;&quot;" width="967" height="371" /></div>
<!--遮罩結束-->
...
<div class="banner">
<ul>
<li><img src="<%= ResolveUrl("~/Assets/images/newbanner.jpg") %>"" alt="Tayana Yachts" /></li>
</ul>
...
<div class="from01"><p> Please Enter your contact information<span class="span01">*Required</span>
  ...
  <table>
    ...
    <tr>
      <td class="from01td01">&nbsp;</td>
      <td class="f_right"><a href="#"><img src="images/buttom03.gif" alt="submit" width="59" height="25" /></a></td>
    </tr>
  </table>  
</div>
<!--表單-->
...
<!--------------------------------落款結束----------------------------------------------------> 
    ...
    <script type="text/javascript" src="<%= ResolveUrl("~/Assets/Scripts/jquery.min.js") %>"></script>
<script type="text/javascript" src="<%= ResolveUrl("~/Assets/Scripts/jquery.cycle.all.2.74.js") %>"></script>
